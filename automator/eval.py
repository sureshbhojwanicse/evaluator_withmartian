...
from llm_judge.judges import BaselineComparisonJudge, GroundTruthComparisonJudge, ExactMatchJudge
...
if __name__ == "__main__":
    ...
    for i, judge_prompt in enumerate(prompts, start=1):
        ...
        acc_score = (eval_result["exp_judge_score"] == eval_result["ideal_judge_score"]).mean()
